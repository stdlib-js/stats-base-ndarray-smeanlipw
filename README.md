...
```c
#include "stdlib/stats/base/ndarray/smeanlipw.h"
```

#### stdlib_stats_smeanlipw( arrays )
...
float v = stdlib_stats_smeanlipw( arrays );
// returns 2.5f
...
```c
float stdlib_stats_smeanlipw( const struct ndarray *arrays[] );
```
